Public Class cKPI_TEMPORAL
    Inherits cBase
    Implements IDisposable

#Region "Constantes Privadas"
    Private Const strConsulta = "SELECT CODIGO, DESCRIPCION, ORDEN, UPPER(DESCRIPCION) UPPER_DESCRIPCION " & _
                                "FROM KPI_TEMPORAL " & _
                                "WHERE 1=1 "
#End Region
