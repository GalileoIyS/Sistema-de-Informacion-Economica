...
public class ProcessorImportJson
{
    ...
    public ProcessorImportJson(AsyncProcessorDetail processor_detail)
    {
    ...
    private DateTime? ConvertirStringToFecha(string Fecha)
    {
        ...
        System.Globalization.CultureInfo cultureInfo = System.Globalization.CultureInfo.GetCultureInfo(ProcessorDetail.DatetimeFormat);

        string[] fmts = cultureInfo.DateTimeFormat.GetAllDateTimePatterns();
