...
function ajaxFileUpload() {
    ...
    if ($.inArray(ext, ['json']) == -1) {
        alert('Solo se aceptan ficheros tipo json');
    }
    else {
...
function populateStep2() {
    ...
    importObject.readJson($(this).returnOK, $(this).returnNO);
}
...
function onFinishCallback() {
    ...
    importObject.writeJson(columnsObject.serialize(), attributeObject.serialize(), $(this).returnOK, $(this).returnNO);
}
