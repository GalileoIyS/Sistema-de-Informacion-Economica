...
public partial class registrado_importcsv : BasePage
{
    ...
    private void Page_Error(object sender, EventArgs e)
    {
        ...
        if (exc is InvalidOperationException)
        {
            ...
            Server.Transfer("~/errors/customerror.aspx?handler=Page_Error%20-%importcsv.aspx",
                true);
        }
    }
    #endregion
        ...
        if (this.idindicator.HasValue)
        {
            using (Clases.cKPI_INDICATORS objIndicador = new Clases.cKPI_INDICATORS())
            {
                ...
                if (objIndicador.bConsultar())
                {
                    ...
                    txtDescripcionImport.Text = "Data imported from a csv file source";
                }
            }
        }
    }
