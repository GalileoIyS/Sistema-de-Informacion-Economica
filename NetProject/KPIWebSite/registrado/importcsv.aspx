<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/NormalPage.master"
    AutoEventWireup="true" CodeFile="importcsv.aspx.cs" Inherits="registrado_importcsv" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="OneColumnPlaceHolder" runat="Server">
    ...
    <div class="container margin-top-lg margin-bottom-lg">
        ...
        <ul class="breadcrumb">
            ...
            <li><span class="current-page"><span class="glyphicon glyphicon-save"></span>&nbsp;<strong>Import CSV data</strong></span></li>
        </ul>
        <div class="well">
            <a href="#" class="btn btn-primary btn-circle btn-xl pull-left margin-right-10"><i class="fa fa-2x fa-magic"></i></a>
            <h5>Welcome to the import data assistance. A wizard will guide you through a series of simple steps to help you importing the data through an CSV file</h5>
        </div>
        <div class="widget-body fuelux">
            <div class="wizard" id="ImportWizard">
                <ul class="steps">
                    ...
                    <li data-target="#step5"><span class="badge">5</span>Finish<span class="chevron"></span></li>
                </ul>
                <div class="actions">
                ...
                <div class="form-horizontal">
                    <div id="step1" class="step-pane active">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <h4 class="StepTitle">Select CSV Data Source</h4>
                                <div>
                                    Through this simple 4 step wizard, you can import the information stored in a CSV file automatically on the datasets associated with this indicator.
                                </div>
                                <fieldset>
                                    <legend><i class="fa fa-file-excel-o"></i>&nbsp;CSV Data Source File</legend>
                                    <div class="well">
                                        <div class="row">
                                ...
                                <fieldset>
                                    <legend><i class="fa fa-keyboard-o"></i>&nbsp;Delimiter Character</legend>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Character</label>
                                        <div class="col-md-8">
                                            <asp:TextBox runat="server" ID="txtDelimiterCharacter" ClientIDMode="Static" CssClass="form-control" MaxLength="1" Width="40" />
                                        </div>
                                    </div>
                                </fieldset>
                                <div id="messageFileExists" class="alert alert-info fade in margin-top-10">
                                    <i class="fa-fw fa fa-info"></i>Remember that <strong class="color-primario-foreground">you must upload the CSV file first</strong> in order to continue the proccess.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="step2" class="step-pane">
                        <h4 class="StepTitle">Source Fields</h4>
                        <p>
                            On the table above, we show the first 12 rows detected on the CSV file. Please, specify which fields correspond to each attribute note that the <strong>Date field </strong>and the <strong>Value Field </strong>are strictly <strong class="color-terciario-foreground">required</strong>.
                        </p>
                    ...
                    <div id="step3" class="step-pane">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <h4 class="StepTitle">Specify the date format</h4>
                                <p>Decide what would you like to do with the date format:</p>
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-md-8">
                                            <label class="radio radio-inline">
                                                <asp:RadioButton ID="rbValidDateFormat" ClientIDMode="Static" runat="server" Checked="true" GroupName="GrpDateFormat" />
                                                <span>I want to select one of the valid format detected</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Detected Formats</label>
                                        <div class="col-md-8">
                                            <asp:DropDownList ID="cmbValidDateFormat" runat="server" CssClass="form-control input-sm" ClientIDMode="Static">
                                        </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-8">
                                            <label class="radio radio-inline">
                                                <asp:RadioButton ID="rbCustomDateFormat" ClientIDMode="Static" runat="server" GroupName="GrpDateFormat" />
                                                <span>I want to manually specify the right one</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Input Formats</label>
                                        <div class="col-md-8">
                                            <asp:TextBox runat="server" ID="txtCustomDateFormat" ClientIDMode="Static" CssClass="form-control" placeholder="Enter the format..." Enabled="false" MaxLength="255" />
                                            <p class="note"><strong>Remember:</strong> Use the next characters: y = Year, M = Month and D = Day</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <h4 class="StepTitle">Fill Other Attribute Values</h4>
                    ...
                    <div id="step4" class="step-pane">
                        <h4 class="StepTitle">What would you like to do if data existed for a certain date and attributes?</h4>
                        <p>
                    ...
                    <div id="step5" class="step-pane">
                        <h4 class="StepTitle">Enter a name and description</h4>
                        <p>
...
<asp:Content ID="ContentScript" runat="server" ContentPlaceHolderID="ScriptsContentPlaceHolder">
    ...
    <!-- Codigo de página -->
    <script src="<%=Page.ResolveUrl("~/scripts/custom/pages/importcsv.js") %>" type="text/javascript"></script>
</asp:Content>
