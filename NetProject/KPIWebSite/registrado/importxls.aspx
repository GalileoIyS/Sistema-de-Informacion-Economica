<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/NormalPage.master"
    AutoEventWireup="true" CodeFile="importxls.aspx.cs" Inherits="registrado_importxls" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="OneColumnPlaceHolder" runat="Server">
    ...
    <div class="container margin-top-lg margin-bottom-lg">
        ...
        <ul class="breadcrumb">
            ...
            <li><span class="current-page"><span class="glyphicon glyphicon-save"></span>&nbsp;<strong>Import XLS data</strong></span></li>
        </ul>
        <div class="well">
            <a href="#" class="btn btn-primary btn-circle btn-xl pull-left margin-right-10"><i class="fa fa-2x fa-magic"></i></a>
            <h5>Welcome to the import data assistance. A wizard will guide you through a series of simple steps to help you importing the data through an XLS file</h5>
        </div>
                ...
                <div class="form-horizontal">
                    <div id="step1" class="step-pane active">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <h4 class="StepTitle">Select XLS Data Source and Delimiter Character</h4>
                                <div>
                                    Please click on the button labeled <strong>Browse ...</strong>&nbsp;and select the file with extension *.xls or *.xlsx from your hard drive. Then, wait a few seconds until the file is uploaded to our server.
                                </div>
                                <fieldset>
                                    <legend><i class="fa fa-file-excel-o"></i>&nbsp;XLS Data Source File</legend>
                                    <div class="well">
                                        <div class="row">
                                ...
                                <div id="messageFileExists" class="alert alert-info fade in margin-top-10">
                                    <i class="fa-fw fa fa-info"></i>Remember that <strong class="color-primario-foreground">you must upload the XLS file first</strong> in order to continue the proccess.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="step2" class="step-pane">
                        ...
                        <p>
                            On the table above, we show the first 10 rows detected on the excel file. Please, specify which fields correspond to each attribute.
                        </p>
                        ...
                        <fieldset>
                            <legend>Available Excel Sheets</legend>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Sheets</label>
                                <div class="col-md-8">
                                    <select id="cmbXLSSheets" class="form-control">
                                    </select>
                                </div>
                            </div>
                        </fieldset>
...
<asp:Content ID="ContentScript" runat="server" ContentPlaceHolderID="ScriptsContentPlaceHolder">
    ...
    <!-- Codigo de página -->
    <script src="<%=Page.ResolveUrl("~/scripts/custom/pages/importxls.js") %>" type="text/javascript"></script>
</asp:Content>
