<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/NormalPage.master"
    AutoEventWireup="true" CodeFile="importxml.aspx.cs" Inherits="registrado_importxml" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="OneColumnPlaceHolder" runat="Server">
    ...
    <div class="container margin-top-lg margin-bottom-lg">
        ...
        <ul class="breadcrumb">
            ...
            <li><span class="current-page"><span class="glyphicon glyphicon-save"></span>&nbsp;<strong>Import XML data</strong></span></li>
        </ul>
        <div class="well">
            <a href="#" class="btn btn-primary btn-circle btn-xl pull-left margin-right-10"><i class="fa fa-2x fa-magic"></i></a>
            <h5>Welcome to the import data assistance. A wizard will guide you through a series of simple steps to help you importing the data through an XML file</h5>
        </div>
            ...
            <div class="step-content well">
                <div class="form-horizontal">
                    <div id="step1" class="step-pane active">
                        <div class="row">
                            <div class="col-lg-4">
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/images/indicators/que-son-datasets.png" CssClass="img-responsive margin-top-10" />
                            </div>
                            <div class="col-lg-8">
                                <h4 class="StepTitle"><strong>Step 1. </strong>Select XML Data Source</h4>
                                <div>
                                    Please click on the button labeled <strong>Browse ... </strong>and select the file with extension *.xml from your hard drive. Then click on the button<strong> Upload XML </strong>so that the system can store it on our server.
                                </div>
                                <fieldset>
                                    <legend><i class="fa fa-file-excel-o"></i>&nbsp;XML Data Source file</legend>
                                    <div class="well">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <span id="uploadOkMessage" class="hidden">
                                                    <img src="../images/buttons/check.png" alt="exito" />The file was successfully uploaded</span>
                                ...
                                <div id="messageFileExists" class="alert alert-info fade in margin-top-10">
                                    <i class="fa-fw fa fa-info"></i>Remember that <strong class="color-primario-foreground">you must upload the XML file first</strong> in order to continue the proccess.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="step2" class="step-pane">
                        ...
                        <p>
                            On the table above, we show the first 12 rows detected on the XML file. Please, specify which fields correspond to each attribute.
                        </p>
...
<asp:Content ID="ContentScript" runat="server" ContentPlaceHolderID="ScriptsContentPlaceHolder">
    ...
    <!-- Codigo de página -->
    <script src="<%=Page.ResolveUrl("~/scripts/custom/pages/importxml.js") %>" type="text/javascript"></script>
</asp:Content>
